...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints "John", "Smith", "123456790" because emp3 is pointing to the same Employee as emp1
		// emp3.getHourlyRate(); // returns syntax error because hourly rate is not defined for emp3 or for emp1
		...
		//PartTimeEmployee pEmp3 = (PartTimeEmployee) emp1; <-- Ran the Code It does not complile, I commented it 
		// TODO To complete
		// This instruction does not compile
		// This instruction returns a ClassCastException at run time
		// because we are trying to cast Pemp3 as PartTimeEmployee using a full time employee emp1
		// partTimeEmployee extends Employee and we cannot cast a Employee as PartTimeEmplyee but we should be able to do the reverse
